      ...
      <div style="padding: 30px; background-color: #ffffff;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 25px; font-size: 14px;">
          ...
          <tr style="border-bottom: 1px solid #eee;">
            ...
            <td style="padding: 10px 0;">2026年10月15日（木） 13:35〜15:30 <span style="font-size: 12px; color: #888;">(13:20開場)</span></td>
          </tr>
          <tr style="border-bottom: 1px solid #eee;">
            <td style="padding: 10px 0; font-weight: bold; color: #666;">会場</td>
            <td style="padding: 10px 0;">
              〒221-0835 神奈川県横浜市神奈川区鶴屋町2-24-2 かながわ県民センター3階 301会議室<br>
              <a href="https://maps.google.com/?q=かながわ県民センター" target="_blank" style="color: #2e6f40; text-decoration: none; font-size: 12px;">🗺️ Googleマップで開く</a>
            </td>
          </tr>
          <tr style="border-bottom: 1px solid #eee;">
            <td style="padding: 10px 0; font-weight: bold; color: #666;">持ち物</td>
            <td style="padding: 10px 0;">名刺 60枚程度 <span style="font-size: 12px; color: #888;">(受付にて2枚ご提出いただきます)</span></td>
          </tr>
          <tr>
